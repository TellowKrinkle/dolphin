...
static bool DetectIntelGPUFBFetch(id<MTLDevice> dev)
{
  ...
  // doesn't insert any fbfetch instructions The Broadwell compiler inserts the Skylake fbfetch
  // instruction, but Broadwell doesn't support that.  It seems to make the shader not do anything
