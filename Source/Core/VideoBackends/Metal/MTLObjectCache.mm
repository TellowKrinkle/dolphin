...
public:
  ...
  struct PipelineID
  {
    ...
    template <size_t N>
    static void CopyAll(VertexAttribute (&output)[N], const AttributeFormat (&input)[N])
    {
    ...
    VertexAttribute v_normals[3];
    VertexAttribute v_colors[2];
    VertexAttribute v_texcoords[8];
